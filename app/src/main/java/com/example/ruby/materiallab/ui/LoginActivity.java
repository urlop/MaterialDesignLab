 ...
 * Contains basic material form EditTexts & Errors.
 */
public class LoginActivity extends AppCompatActivity{
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            UIHelper.showProgress(this, mProgressView, mLoginFormView, true);
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(final Boolean success) {
            mAuthTask = null;
            UIHelper.showProgress(LoginActivity.this, mProgressView, mLoginFormView, false);
            ...
            if (success) {
                ...
                til_password.setError(getString(R.string.error_incorrect_password));
